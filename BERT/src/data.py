...
class ArgumentsDataset(Dataset):
    ...
    def __init__(self, arguments_fname: str, label_fname: Union[str, None] = None, pad_length=None, training=True, transform=None):
        """
    ...
    def get_pad_length(self):
        ...
        for premise in premises:
          ...
          if premise_len > max_len:
            max_len = premise_len

        pad_length = 1
        while pad_length < max_len:
          pad_length *= 2
        return pad_length
